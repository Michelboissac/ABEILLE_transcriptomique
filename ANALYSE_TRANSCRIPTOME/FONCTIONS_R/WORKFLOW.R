WORKFLOW = function(tableau_counts,normalisation = c("pas_de_normalisation","vst","vst_conditions", "vst_peu_de_genes","log_rpkm", "log_tpm", "rlog"),noms_genes="",liste_conditions_a_garder_etoile=NULL,nom_repertoire_output=""){
  #sources
  source(paste0(repertoire_fonctions,"/HEATMAP.R"))
  source(paste0(repertoire_fonctions,"/DIAG_VENN.R"))
  source(paste0(repertoire_fonctions,"/ACP.R"))
  source(paste0(repertoire_fonctions,"/SUPPRIME_CHANGE_NOMS_COLONNES_LIGNES.R"))
  source(paste0(repertoire_fonctions,"/ANALYSE_EXPRESSION_DIFF.R"))
  source(paste0(repertoire_fonctions,"/NORMALISATION.R"))
  source(paste0(repertoire_fonctions,"/creation_tableau_pour_igv.R"))
  source(paste0(repertoire_fonctions,"/STATS.R"))
  source(paste0(repertoire_fonctions,"/CORRELATION.R"))
  ...
  function_CNN(counts = counts_norm_genes,R2= 0.99,filename = paste0(chemin_repertoire_output,"/",nom_repertoire_output,".",normalisation,"_CNN"))
